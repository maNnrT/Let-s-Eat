...
function Homepage() {
  return (
    ...
    >
      <div className="absolute top-[37rem] left-[3.8rem] right-[3.8rem] h-[48px] flex justify-between">
      ...
      <div className="container flex flex-col justify-start ">
        ...
        <div className="hidden md:flex justify-between items-center mt-[2.8rem] w-[9.6rem]">
          <div className="w-3 h-3 rounded-full bg-71655b"></div>
          <div className="w-3 h-3 rounded-full bg-f6f5f4"></div>
          <div className="w-3 h-3 rounded-full bg-71655b"></div>
          <div className="w-3 h-3 rounded-full bg-71655b"></div>
        </div>
      </div>
